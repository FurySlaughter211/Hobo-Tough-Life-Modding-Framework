...
This folder should contain DLLs needed to build the Framework NOT a mod using it. These are NOT included in the repository because they are copyrighted.
