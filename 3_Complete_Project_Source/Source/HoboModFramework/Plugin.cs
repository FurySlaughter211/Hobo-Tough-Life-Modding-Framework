...
namespace HoboModPlugin
{
    ...
    public class Plugin : BasePlugin
    {
        ...
        public override void Load()
        {
            ...
            SpawnTableInjector.Initialize(Log);
            ...
            ClassInjector.RegisterTypeInIl2Cpp<HoboModFramework.Framework.HoboExplorer>();
            ...
            AddComponent<HoboModFramework.Framework.HoboExplorer>();
